"""
Momentum HOD Trading Strategy - Backtest Runner
...
# Add parent directory to path to import trade module
...
st.caption("Run backtests with customizable parameters and view results")
...
if run_btn:
    with st.spinner("Running backtest..."):
        ...
        if not results.empty:
            # Save to CSV for Trade Analysis page
